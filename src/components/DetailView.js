                    ...
                    <View style={styles.personMetaInfoContainer}>
                        <Card>
                            ...
                            <Card.Actions style={styles.editDeleteButtonsContainer}>
                                <Button color={'#3b3b3b'} onPress={this.onDeletePress.bind(this)}>Delete</Button>
                                <Button color={'#3b3b3b'} onPress={this.onEditPress.bind(this)}>Edit</Button>
                            </Card.Actions>
                        </Card>
                    </View>
                    <View style={styles.actionButtonContainerRoot}>
                        <View style={styles.actionButtonContainer}>
                            <Button color={'#f08e25'} style={{backgroundColor: '#c64c38'}} icon="phone" mode="contained" onPress={() => console.log('Pressed')}>
                                Call
                            </Button>
                        </View>
                        <View style={styles.actionButtonContainer}>
                            <Button color={'#f08e25'} style={{backgroundColor: '#c64c38'}} icon="email" mode="contained" onPress={() => console.log('Pressed')}>
                                E-mail
                            </Button>
                        </View>
                        <View style={styles.actionButtonContainer}>
                            <Button color={'#f08e25'} style={{backgroundColor: '#c64c38'}} icon="message-alert" mode="contained" onPress={() => console.log('Pressed')}>
                                SMS
                            </Button>
                        </View>
                    </View>
